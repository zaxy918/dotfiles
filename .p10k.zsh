# Generated by Powerlevel10k configuration wizard on 2026-07-22 at 04:11 CST.
...
# 2 lines, dotted, left frame, white-ornaments, compact, few icons, concise,
...
() {
  ...
  #######################[ background_jobs: presence of background jobs ]#######################
  # Do show the number of background jobs.
